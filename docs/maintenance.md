...
- Panics inside a cleaner are recovered and logged similarly with additional `panic` and `stack` fields. Neither errors nor panics stop other cleaners from running.
